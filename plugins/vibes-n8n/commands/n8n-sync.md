...
allowed-tools: ["mcp__vibes-n8n__sync_workflows", "mcp__vibes-n8n__list_workflows"]
---
...
2. Call `mcp__vibes-n8n__sync_workflows` with the project name
...
4. Optionally call `mcp__vibes-n8n__list_workflows` to show the current state
