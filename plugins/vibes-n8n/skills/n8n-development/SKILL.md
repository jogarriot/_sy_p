...
Use these tools via the `vibes-n8n` MCP server:

| Tool | Usage |
|------|-------|
| `mcp__vibes-n8n__list_workflows` | List all workflows in a project |
| `mcp__vibes-n8n__get_workflow` | Get full workflow JSON by ID or name |
| `mcp__vibes-n8n__sync_workflows` | Pull workflows from remote n8n instance |
| `mcp__vibes-n8n__push_workflow` | Push local changes to remote n8n |
