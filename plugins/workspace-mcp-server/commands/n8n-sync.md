...
allowed-tools: ["mcp__workspace-mcp__sync_workflows", "mcp__workspace-mcp__list_workflows"]
---
...
2. Call `mcp__workspace-mcp__sync_workflows` with the project name
...
4. Optionally call `mcp__workspace-mcp__list_workflows` to show the current state
