...
allowed-tools: ["mcp__workspace-mcp__push_workflow", "mcp__workspace-mcp__get_workflow", "mcp__workspace-mcp__list_workflows"]
---
...
1. Parse arguments for project name and workflow ID
   ...
   - Can use `mcp__workspace-mcp__list_workflows` to help identify workflows

2. Before pushing, optionally show the user what will be pushed:
   - Use `mcp__workspace-mcp__get_workflow` to preview the workflow
   - Confirm with user if they want to proceed

3. Call `mcp__workspace-mcp__push_workflow` with project name and workflow ID
