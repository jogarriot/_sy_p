...
Use these tools via the `workspace-mcp` MCP server:

| Tool | Usage |
|------|-------|
| `mcp__workspace-mcp__list_workflows` | List all workflows in a project |
| `mcp__workspace-mcp__get_workflow` | Get full workflow JSON by ID or name |
| `mcp__workspace-mcp__sync_workflows` | Pull workflows from remote n8n instance |
| `mcp__workspace-mcp__push_workflow` | Push local changes to remote n8n |
