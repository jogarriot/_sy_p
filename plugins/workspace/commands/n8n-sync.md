...
allowed-tools: ["mcp__plugin_workspace__sync_workflows", "mcp__plugin_workspace__list_workflows"]
---
...
2. Call `mcp__plugin_workspace__sync_workflows` with the project name
...
4. Optionally call `mcp__plugin_workspace__list_workflows` to show the current state
