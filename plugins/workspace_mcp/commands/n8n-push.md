...
allowed-tools: ["mcp__plugin_workspace_mcp__push_workflow", "mcp__plugin_workspace_mcp__get_workflow", "mcp__plugin_workspace_mcp__list_workflows"]
---
...
1. Parse arguments for project name and workflow ID
   ...
   - Can use `mcp__plugin_workspace_mcp__list_workflows` to help identify workflows

2. Before pushing, optionally show the user what will be pushed:
   - Use `mcp__plugin_workspace_mcp__get_workflow` to preview the workflow
   - Confirm with user if they want to proceed

3. Call `mcp__plugin_workspace_mcp__push_workflow` with project name and workflow ID
