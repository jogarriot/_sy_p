...
Use these tools via the `workspace_mcp` MCP server:

| Tool | Usage |
|------|-------|
| `mcp__plugin_workspace_mcp__list_workflows` | List all workflows in a project |
| `mcp__plugin_workspace_mcp__get_workflow` | Get full workflow JSON by ID or name |
| `mcp__plugin_workspace_mcp__sync_workflows` | Pull workflows from remote n8n instance |
| `mcp__plugin_workspace_mcp__push_workflow` | Push local changes to remote n8n |
